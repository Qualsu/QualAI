...
def chat(request: ChatRequest) -> ChatResponse:
    ...
    return ChatResponse(account_id=account_id, session_id=session_id, response=reply, history=history)
...
def get_session_history(request: SessionRequest) -> SessionHistoryResponse:
    ...
    return SessionHistoryResponse(account_id=account_id, session_id=session_id, history=history)
...
def get_all_history(request: AccountRequest) -> AllHistoryResponse:
    ...
    with session_lock:
        all_sessions = {key: value for key, value in sessions.get(account_id, {}).items()}
    return AllHistoryResponse(account_id=account_id, sessions=all_sessions)
